...
MH=function(X)
{
  ...
  coverageMH<-c()
  mseMH=c()
  MH1<-netmetabin(event1=r1,event2=r2,n1=n1,n2=n2, studlab = studlab,treat1=t1, treat2=t2, method = "MH", data=X$data,cc.pooled = T,incr = 0.5)
...
NCH=function(X)
{
  ...
  NCH1<-netmetabin(event1=r1,event2=r2,n1=n1,n2=n2, studlab = studlab,treat1=t1, treat2=t2, method = "NCH", data=X$data,cc.pooled = T,inc=0.5)
